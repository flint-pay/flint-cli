...
func commandDefinitions() []*Command {
	...
	commands := []*Command{
		...
		{Name: "upgrade", Path: pathWithFlint("upgrade"), Description: "Upgrade Flint CLI to the latest stable release", Local: true, MCPHidden: true, Examples: ex("flint upgrade", "flint upgrade --output json")},
